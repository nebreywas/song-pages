...
export const SAFE_DIRECT_HOTKEY_POOL: SafeHotkeyDefinition[] = [
  ...
  { id: 'ocaw-backslash', logicalBinding: `${MODIFIER_OCAW}+\\`, macBinding: 'Alt+Command+\\', windowsBinding: 'Alt+Super+\\', auditVersion: SAFE_HOTKEY_AUDIT_VERSION, enabled: true },
  { id: 'ocaw-comma', logicalBinding: `${MODIFIER_OCAW}+,`, macBinding: 'Alt+Command+,', windowsBinding: 'Alt+Super+,', auditVersion: SAFE_HOTKEY_AUDIT_VERSION, enabled: true },
  { id: 'ocaw-period', logicalBinding: `${MODIFIER_OCAW}+.`, macBinding: 'Alt+Command+.', windowsBinding: 'Alt+Super+.', auditVersion: SAFE_HOTKEY_AUDIT_VERSION, enabled: true },
  { id: 'ocaw-slash', logicalBinding: `${MODIFIER_OCAW}+/`, macBinding: 'Alt+Command+/', windowsBinding: 'Alt+Super+/', auditVersion: SAFE_HOTKEY_AUDIT_VERSION, enabled: true },
